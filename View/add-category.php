        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                ...
                <div class="block-fluid">
                    <form method="POST" action="index.php?controller=CategoryController&action=addCategory" enctype="multipart/form-data">
                    	<div class="row-form">
                            <div class="span3">Category Name:</div>
                            <div class="span9"><input type="text" name="categoryname" placeholder="some text value..."/></div>
                            <div class="clear"></div>
                        </div> 
                        <div class="row-form">
