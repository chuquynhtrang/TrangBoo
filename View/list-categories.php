                ...
                <div class="block-fluid table-sorting">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" class="table" id="tSortable_2">
                        ...
                        <form method="POST" action="index.php?controller=CategoryController&action=index&page=<?php echo $_GET['page'];?>">
                            ...
                            $href_search="index.php?controller=CategoryController&action=index&search=".$_GET['search'];
                            $href="index.php?controller=CategoryController&action=index";
                            ?>
                            <tr>
                                ...
                                <?php if(isset($_GET['search'])){ ?>
                                    ...
                                    <th width="35%" class="<?php echo $class;?>">
                                        <a href="<?php echo $href_search;?>&sort=categoryname&order=<?php echo $order;?>&page=<?php echo $_GET['page'];?>">Categoryname</a>
                                    </th>
                                ...
                                <?php }else{ ?>
                                    ...
                                    <th width="35%" class="<?php echo $class;?>">
                                        <a href="<?php echo $href;?>&sort=categoryname&order=<?php echo $order;?>&page=<?php echo $_GET['page'];?>">Categoryname</a>
                                    </th>
                                    <th width="20%" class="<?php echo $class;?>">
                        ...
                        <?php foreach($data_limit as $dt){?>
                            <tr>
                                ...
                                <td><a href="index.php?controller=CategoryController&action=editCategory&id=<?php echo $dt['id']; ?>" class="btn btn-info">Edit</a></td>
                            </tr>
                        <?php } ?>
                    </table>
